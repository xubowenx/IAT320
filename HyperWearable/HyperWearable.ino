...
//Adafruit_NeoPixel strips(LED_COUNT, LED_PIN, NEO_GRB + NEO_KHZ800);

void setup() 
{
  Serial.begin(9600);
  CircuitPlayground.begin();
//  strips.begin();           // INITIALIZE NeoPixel strip object (REQUIRED)
//  strips.show();            // Turn OFF all pixels ASAP
//  strips.setBrightness(50); // Set BRIGHTNESS to about 1/5 (max = 255)
}
...
//  if(WheelPos < 85) {
//    return CircuitPlayground.strip.Color(WheelPos * 3, 255 - WheelPos * 3, 255);
//  } 
//  else if(WheelPos < 170) {
//    WheelPos -= 85;
//    return CircuitPlayground.strip.Color(255 - WheelPos * 3, 248, WheelPos * 3);
//  } 
//  else {
//    WheelPos -= 170;
//    return CircuitPlayground.strip.Color(112, WheelPos * 3, 255 - WheelPos * 3);
//  }

//-----------------------------------------------------------------------------

  if(WheelPos < 85) {
    return CircuitPlayground.strip.Color(112, 248, 255);
  } 
  else if(WheelPos < 170) {
    WheelPos -= 85;
    return CircuitPlayground.strip.Color(244, 10, 24);
  } 
  else {
    WheelPos -= 170;
    return CircuitPlayground.strip.Color(112, 248, 255);
